CREATE MATERIALIZED VIEW MV_SSRG_CUSTOM_REPORT
TABLESPACE KUR
BUILD DEFERRED /* direfresh manual menggunakan SP */
REFRESH COMPLETE /* isi table bertambah dan banyak menggunakan join */
ON DEMMAND /* refresh akan terjadi ketika dipanggil */
DISABLE QUERY REWRITE /* Opsional: Akan menonaktifkan Query Rewrite karrne MV hanya untuk pelaporan, bukan optimasi query OLTP */
AS 
  SELECT A.KODE_BANK,
         B.NAMA_BANK,
         A.TAHUN,
         ...
         R.KODE_KOMODITAS,
         T.NAMA_KOMODITAS,
		 O_CHAR (SYSDATE, 'YYYY/MM/DD HH24:MI:SS') AS LAST_REFRESH_DATE,
